...
public class Driver {
    ...
    Player player1 = new Player(new StrategyHMC(new double[] {1.,0.,0.}, game, 1), game, 1);
    ...
    for (int i = 0; i < totalRounds; i++) {
        ...
        if (DEBUG) System.out.println("\nPlayer 1 plays " + game.actionAsString(p1Choice) +
        ", player 2 plays " + game.actionAsString(p2Choice));
    ...
    System.out.println("Player1 utility per game: " + (p1TotalUtility/totalRounds) +
    " Player2 utility per game: " + (p2TotalUtility/totalRounds));
    System.out.println("Player 1 Strategy:");
    double[] s= player1.getStrategy().getStrategy();
    for (int i = 0; i < s.length; i++) {
        System.out.print(" " + s[i]);
    }
    
    System.out.println("\nPlayer 2 Strategy:");
    s= player2.getStrategy().getStrategy();
    for (int i = 0; i < s.length; i++) {
        System.out.print(" " + s[i]);
    }
    System.out.println();
