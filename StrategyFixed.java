...
public class StrategyFixed implements Strategy {
    ...
    if (strategySum == 0.0) throw new IllegalArgumentException("The weights in the strategy array must sum to a positive value");
    ...
    // No update needed for a fixed strategy
    }
